...
%changelog
* Mon Mar 31 2014 Tomas Tomecek <ttomecek@redhat.com> - 4.0.2-12
- explicitly depend on SCL runtime

* Thu Mar 20 2014 Tomas Tomecek <ttomecek@redhat.com> - 4.0.2-11
- rebuilt with latest scl-utils (dependencies problems)

* Thu Feb 20 2014 Bohuslav Kabrda <bkabrda@redhat.com> - 4.0.2-10
- add licenses to all subpackages
Resolves: rhbz#1066038
